...
export class ThemeService {
  ...
  private readonly _lightThemeColors: { [key: string]: string } = {
    ...
    '--shadow-light-overlay': 'rgba(0, 0, 0, 0.1)',
    '--icon-filter': 'none',
    '--zoom-icon-filter': 'invert(1)',
    '--sky-blue': '#0ea5e9',
    '--sky-blue-light-bg': '#e0f2fe',
    '--sky-blue-shadow': 'rgba(14, 165, 233, 0.2)',
    '--text-gray-dark': '#1f2937',
    '--text-gray-medium-alt': '#6b7280',
    ...
    '--greyscale-greyscale-25': 'rgba(246, 248, 250, 1)',
    '--greyscale-greyscale-50': 'rgba(236, 239, 243, 1)',
    '--greyscale-greyscale-100': 'rgba(223, 225, 231, 1)',
    '--primary-blue': '#2d71f7',
    '--primary-blue-light': '#578df9',
    '--Primary100': 'rgba(171, 198, 252, 1)',
  ...
  private readonly _darkThemeColors: { [key: string]: string } = {
    ...
    '--shadow-light-overlay': 'rgba(0, 0, 0, 0.2)',
    '--icon-filter': 'brightness(0) invert(1)',
    '--zoom-icon-filter': 'invert(0)',
    '--sky-blue': '#3b82f6',
    '--sky-blue-light-bg': '#1e3a8a',
    '--sky-blue-shadow': 'rgba(59, 130, 246, 0.3)',
    '--text-gray-dark': '#f3f4f6',
    '--text-gray-medium-alt': '#9ca3af',
    '--success-green': '#34d399',
    '--success-bg-light': '#064e3b',
    '--orange-light-bg': '#7c2d12',
    '--danger-color': '#f87171',
    // Additional theme variables for dark mode
    '--base-background': '#1f2937',
    '--greyscale-greyscale-25': 'rgba(55, 65, 81, 1)',
    '--greyscale-greyscale-50': 'rgba(55, 65, 81, 1)',
    '--greyscale-greyscale-100': 'rgba(75, 85, 99, 1)',
    '--primary-blue': '#578df9',
    '--primary-blue-light': '#81aafa',
    '--Primary100': 'rgba(171, 198, 252, 0.5)',
    '--dark-gradient': 'linear-gradient(180deg, #374151 0%, #1f2937 100%)',
